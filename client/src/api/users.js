...
export const getUser = async () => {
    try {
        ...
        const res = await fetch(
            "https://tasteless-hope-production.up.railway.app/bike-me-now/api/usuarios/buscar-por-token",
            {
                headers: {
...
export const getUsers = async () => {
    try {
        const { token } = JSON.parse(localStorage.getItem("accessToken"));
        const res = await fetch(
            "https://tasteless-hope-production.up.railway.app/bike-me-now/api/usuarios",
            {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
...
export const putUserRol = async (user) => {
    try {
        const { token } = JSON.parse(localStorage.getItem("accessToken"));
        const res = await fetch(
            `https://tasteless-hope-production.up.railway.app/bike-me-now/api/usuarios/${user.usuarioId}/cambiar-rol?rol=${user.rol}`,
            {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${token}`,
